...
def generate_barcodes(license_number, issue_date, expiry_date, dob, name, address, sex, height, weight, license_class, endorsements, restrictions, eye_color, hair_color, dd_info):
    ...
    pdf417 = pdf417gen.encode(data_to_encode_pdf417)
    pdf417_image = pdf417gen.render_image(pdf417, scale=3, padding=10)
    ...
    code128 = Code128(data_to_encode_code128, writer=ImageWriter())
    barcode_image_code128 = code128.save(f'{folder_name}/generated_barcode_code128.png')
